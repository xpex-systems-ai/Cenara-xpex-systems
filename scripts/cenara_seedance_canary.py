...
def main() -> int:
    ...
    prompt = (
        "Cinematic launch film for XPeX Academy. A futuristic premium AI learning studio at night, "
        "elegant dark navy environment with subtle cyan and warm orange accents, holographic knowledge "
        "interfaces, natural camera dolly, confident adult presenter silhouette interacting with floating "
        "AI diagrams, refined commercial lighting, sophisticated motion design feeling, clean composition, "
